                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <Link href="/analytics" className="block">
                        <div className="bg-white p-6 rounded-lg shadow-md border-t-4 border-yellow-500 hover:shadow-lg transition-shadow">
                            ...
                            <p className="text-gray-600 text-sm">Analyze your performance metrics and trends</p>
                            <div className="mt-4 text-yellow-600 text-sm font-medium">View Analytics →</div>
                        </div>
                    </Link>
                </div>
            </main>
